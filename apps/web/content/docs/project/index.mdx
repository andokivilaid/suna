...
its memory, and its [knowledge](/docs/project/knowledge) documents. Keep it
small — Kortix clones it into every session.
...
<CardGroup>
  ...
  <Card icon="book-open" title="Knowledge" href="/docs/project/knowledge">Documents your agents can read.</Card>
